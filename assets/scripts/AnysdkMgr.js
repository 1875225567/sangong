cc.Class({
    ...
    share:function(title,desc){
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod(this.ANDROID_API, "Share", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V",cc.vv.SI.appweb,title,desc,false);
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    openUrl:function(url){
        console.log('AnysdkMgr.openUrl==>>'+url);
        if (cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/miduo/ShopURL", "openURL", "(Ljava/lang/String;)V",url);
        }
    },
});
