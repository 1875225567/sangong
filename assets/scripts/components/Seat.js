cc.Class({
    ...
    onLoad: function () {
        ...
        this._sprIconbg = this.node.getChildByName("icon");
        this._lblName = this.node.getChildByName("name").getComponent(cc.Label);
        this._lblScore = this.node.getChildByName("score").getComponent(cc.Label);
        this._voicemsg = this.node.getChildByName("voicemsg");
        this._xuanpai = this.node.getChildByName("xuanpai");
        // this._btnoutuser = this.node.getChildByName("actionBtn").getChildByName("btnoutuser");
        // this._btnoutuser.active = false;
        this._btnsitdown = this.node.getChildByName("actionBtn").getChildByName("btnsitdown");
    ...
    onIconClicked:function(){
        ...
        if(this._userId != null && this._userId > 0){
           var seat = cc.vv.gameNetMgr.getUserByID(this._userId);
            var sex = 0;
            ...
            cc.vv.userinfoShow.show(seat.name,seat.userId,seat.gems,seat.coins,seat.yuanbaos,iconSprite,sex,seat.ip);
        }
    },
    ...
    refresh:function(){
        ...
        if(this._lblScore != null){
            if(this._score){
                this._lblScore.string = cc.vv.gameNetMgr.getNumbersToString(this._score);
            }
            else{
        ...
        var beuser = this._userName != null && this._userName != "";
        //this._btnoutuser.active = beuser;
        this._btnsitdown.active = !beuser;

        if(this._sprIconbg){
            this._sprIconbg.active = this._userName != "";
        }
        //this.node.active = this._userName != null && this._userName != "";
    },
    
    setInfo(name,score,id){
        if(name.length > 3){
            this._userName = name.slice(0,3) + "...";
        }
        else{
            this._userName = name;
        }
    ...
    setID:function(id){
        ...
        if(this._sprIcon){
            if(id != 0){
                ...
                this._sprIcon.node.getComponent(cc.Sprite).spriteFrame = "";
            }
        }
    },
    ...
    refreshXuanPaiState:function(){
        console.log("refreshXuanPaiState");
